...
Not available
Not all the data of 2021 is filled, so we need to strip the data which is NA
...
**Write your answer here**
The number of visitors mainly accumulates on small number of attractions. The number of visitors does not spread evenly.
